# This script is for testing replicate data on the model built from LRDA_VAL.py
...
# Use predict() directly to get class labels
y_pred = lr_model.predict(X_external)
