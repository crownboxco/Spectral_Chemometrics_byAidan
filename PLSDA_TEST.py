# This script is for testing replicate data on the model built from PLSDA_VAL.py
...
# === Make predictions ===
y_pred_probs = pls_model.predict(X_external)
...
if 'Species' in df_external.columns:
    ...
    # Identify which classes are actually present in predictions or truth
